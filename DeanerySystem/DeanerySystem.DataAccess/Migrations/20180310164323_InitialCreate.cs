        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreditSessionStart = table.Column<DateTime>(nullable: false),
                    End = table.Column<DateTime>(nullable: false),
                    Number = table.Column<int>(nullable: false),
                    SecondWritingStart = table.Column<DateTime>(nullable: false),
                    SessionStart = table.Column<DateTime>(nullable: false),
                    Start = table.Column<DateTime>(nullable: false),
                    ThirdWritingStart = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumberOfConsultations = table.Column<int>(nullable: false),
                    NumberOfLectures = table.Column<int>(nullable: false),
                    NumberOfPracticalClasses = table.Column<int>(nullable: false),
                    NumberOflLaboratoryClasses = table.Column<int>(nullable: false),
                    PassingDate = table.Column<DateTime>(nullable: true),
                    SemesterControl = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClassNumberTimes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClassNumberTimes_TimeTables_TimeTableId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EducationalPlans_Groups_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Groups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EducationalPlans_Semesters_SemesterId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TuitionFee = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Cellules_Journals_JournalId",
                        column: x => x.JournalId,
                        principalTable: "Journals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Cellules_Users_StudentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FailureTickets", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FailureTickets_Users_StudentId",
                        column: x => x.StudentId,
                        principalSchema: "dbo",
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FailureTickets_Subjects_SubjectId",
                        column: x => x.SubjectId,
                        principalTable: "Subjects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    ExamMark = table.Column<double>(nullable: false),
                    StudentId = table.Column<Guid>(nullable: false),
                    SubjectId = table.Column<int>(nullable: false),
                    TermMark = table.Column<double>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProgressRecords_Subjects_SubjectId",
                        column: x => x.SubjectId,
                        principalTable: "Subjects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    Name = table.Column<string>(nullable: true),
                    RectorId = table.Column<Guid>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Universities", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Universities_Users_RectorId",
                        column: x => x.RectorId,
                        principalSchema: "dbo",
                        principalTable: "Users",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(nullable: true),
                    StreamAbbreviation = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Streams", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Streams_Faculties_FacultyId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Departments_Streams_StreamId",
                        column: x => x.StreamId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cellules_JournalId",
                table: "Cellules",
                column: "JournalId");

            migrationBuilder.CreateIndex(
                name: "IX_Cellules_StudentId",
                table: "Cellules",
                column: "StudentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClassNumberTimes_TimeTableId",
                table: "ClassNumberTimes",
                column: "TimeTableId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Departments_StreamId",
                table: "Departments",
                column: "StreamId");

            migrationBuilder.CreateIndex(
                name: "IX_EducationalPlans_GroupId",
                table: "EducationalPlans",
                column: "GroupId");

            migrationBuilder.CreateIndex(
                name: "IX_EducationalPlans_SemesterId",
                table: "EducationalPlans",
                column: "SemesterId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FailureTickets_StudentId",
                table: "FailureTickets",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_FailureTickets_SubjectId",
                table: "FailureTickets",
                column: "SubjectId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProgressRecords_SubjectId",
                table: "ProgressRecords",
                column: "SubjectId");

            migrationBuilder.CreateIndex(
                name: "IX_Streams_FacultyId",
                table: "Streams",
                column: "FacultyId");
