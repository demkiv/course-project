...
namespace DeanerySystem.WebUI.Infrastructure
{
    public class NinjectDependencyResolver : IDependencyResolver
    {
        ...
        {
            //Mock<IFacultyRepository> facultyMock = new Mock<IFacultyRepository>();
            //facultyMock.Setup(m => m.Faculties).Returns(new List<FacultyExample> {
            //    new FacultyExample { Id = 1, Name = "Biology from mock" },
            //    new FacultyExample { Id = 2, Name = "Geography from mock" },
            //    //new FacultyExample { Id = 3, Name = "Geology from mock" },
            //    new FacultyExample { Id = 3, Name = "Economics from mock" },
            //    new FacultyExample { Id = 4, Name = "Electronics from mock" },
            //    new FacultyExample { Id = 5, Name = "Jornalism from mock" },
            //    new FacultyExample { Id = 6, Name = "Foreign Languages from mock" },
            //    new FacultyExample { Id = 7, Name = "History from mock" },
            //    new FacultyExample { Id = 8, Name = "Culture and Arts from mock" },
            //    new FacultyExample { Id = 9, Name = "International Relations from mock" },
            //    new FacultyExample { Id = 10, Name = "Mechanics and Mathematics from mock" },
            //    new FacultyExample { Id = 11, Name = "Applied Mathematics and Information Science from mock" },
            //    new FacultyExample { Id = 12, Name = "Physics from mock" },
            //    new FacultyExample { Id = 13, Name = "Philology from mock" },
            //    new FacultyExample { Id = 14, Name = "Philosophy from mock" },
            //    new FacultyExample { Id = 15, Name = "Chemistry from mock" },
            //    new FacultyExample { Id = 16, Name = "Law from mock" }
            //});

            //kernel.Bind<IFacultyRepository>().ToConstant(facultyMock.Object);
            kernel.Bind<IFacultyRepository>().To<EFFacultyRepository>();


            Mock<IEntitiesRepository> entitiesMock = new Mock<IEntitiesRepository>();
            ...
            entitiesMock.Setup(m => m.Groups).Returns(new List<Group>
            {
                new Group
                {
                    ...
                    ActualSemester = entitiesMock.Object.Semesters.ElementAt(0)
                },
                new Group
                {
                    Id = 2,
            ...
            kernel.Bind<IEntitiesRepository>().ToConstant(entitiesMock.Object);
