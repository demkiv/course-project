...
namespace DeanerySystem.UI.Infrastructure
{
    public class NinjectDependencyResolver : IDependencyResolver
    {
        ...
        private void AddBindings()
        {
            ...
            facultyRepositoryMock.Setup(fr => fr.Get(null, null, "")).Returns(new List<Faculty>
            {
            ...
            streamRepositoryMock.Setup(sr => sr.Get(null, null, "")).Returns(new List<Stream>
            {
                new Stream()
                {
                    Id = 1,
                    ...
                    Faculty = facultyRepositoryMock.Object.Get().ElementAt(11)
                }
            });
            #endregion
            ...
            departmentRepositoryMock.Setup(dr => dr.Get(null, null, "")).Returns(new List<Department>
            {
                new Department()
                {
                    Id = 1,
            ...
            semesterRepositoryMock.Setup(sr => sr.Get(null, null, "")).Returns(new List<Semester>
            {
                new Semester
                {
                    Id = 1,
            ...
            studentRepositoryMock.Setup(sr => sr.Get(null, null, "")).Returns(new List<Student>
            {
                new Student
                {
                    //Id = 1,
            ...
            professorRepositoryMock.Setup(pr => pr.Get(null, null, "")).Returns(new List<Professor>
            {
                new Professor
                {
                    //Id = 4,
            ...
            groupRepositoryMock.Setup(gr => gr.Get(null, null, "")).Returns(new List<Group>
            {
                new Group
                {
                    Id = 1,
                    ...
                    Department = departmentRepositoryMock.Object.Get().ElementAt(0),
                    Students = new List<Student>()
                    {
                        studentRepositoryMock.Object.Get().ElementAt(20),
                        studentRepositoryMock.Object.Get().ElementAt(21),
                        studentRepositoryMock.Object.Get().ElementAt(22),
                        studentRepositoryMock.Object.Get().ElementAt(23),
                        studentRepositoryMock.Object.Get().ElementAt(24),
                        studentRepositoryMock.Object.Get().ElementAt(25),
                        studentRepositoryMock.Object.Get().ElementAt(26),
                        studentRepositoryMock.Object.Get().ElementAt(27),
                        studentRepositoryMock.Object.Get().ElementAt(28),
                        studentRepositoryMock.Object.Get().ElementAt(29),
                        studentRepositoryMock.Object.Get().ElementAt(30),
                        studentRepositoryMock.Object.Get().ElementAt(31),
                        studentRepositoryMock.Object.Get().ElementAt(32),
                        studentRepositoryMock.Object.Get().ElementAt(33),
                        studentRepositoryMock.Object.Get().ElementAt(34),
                        studentRepositoryMock.Object.Get().ElementAt(35),
                        studentRepositoryMock.Object.Get().ElementAt(36),
                        studentRepositoryMock.Object.Get().ElementAt(37),
                        studentRepositoryMock.Object.Get().ElementAt(38),
                        studentRepositoryMock.Object.Get().ElementAt(39)
                    },
                ...
                new Group
                {
                    Id = 2,
                    Name = "ПМІ-42",
                    Mentor = professorRepositoryMock.Object.Get().ElementAt(0),
                    Department = departmentRepositoryMock.Object.Get().ElementAt(0),
                    Students = new List<Student>()
                    {
                        studentRepositoryMock.Object.Get().ElementAt(0),
                        studentRepositoryMock.Object.Get().ElementAt(1),
                        studentRepositoryMock.Object.Get().ElementAt(2),
                        studentRepositoryMock.Object.Get().ElementAt(3),
                        studentRepositoryMock.Object.Get().ElementAt(4),
                        studentRepositoryMock.Object.Get().ElementAt(5),
                        studentRepositoryMock.Object.Get().ElementAt(6),
                        studentRepositoryMock.Object.Get().ElementAt(7),
                        studentRepositoryMock.Object.Get().ElementAt(8),
                        studentRepositoryMock.Object.Get().ElementAt(9),
                        studentRepositoryMock.Object.Get().ElementAt(10),
                        studentRepositoryMock.Object.Get().ElementAt(11),
                        studentRepositoryMock.Object.Get().ElementAt(12),
                        studentRepositoryMock.Object.Get().ElementAt(13),
                        studentRepositoryMock.Object.Get().ElementAt(14),
                        studentRepositoryMock.Object.Get().ElementAt(15),
                        studentRepositoryMock.Object.Get().ElementAt(16),
                        studentRepositoryMock.Object.Get().ElementAt(17),
                        studentRepositoryMock.Object.Get().ElementAt(18),
                        studentRepositoryMock.Object.Get().ElementAt(19)
                    },
                    //EducationalPlans = new List<EducationalPlan>()
                    //{
                    //	new EducationalPlan() { Semester = entitiesMock.Object.Semesters.ElementAt(0) }
            ...
            classNumberTimeRepositoryMock.Setup(cnt => cnt.Get(null, null, "")).Returns(new List<ClassNumberTime>
            {
                new ClassNumberTime()
                {
                    Id = 1,
            ...
            timeTableRepositoryMock.Setup(ttr => ttr.Get(null, null, "")).Returns(new List<TimeTable>
            {
                new TimeTable //щербатий лекція
                {
                    ...
                    {
                        classNumberTimeRepositoryMock.Object.Get().ElementAt(5)
                    }
                },
                ...
                new TimeTable // право лекція
                {
                    ...
                    ClassNumberTimes = new List<ClassNumberTime>
                    {
                        classNumberTimeRepositoryMock.Object.Get().ElementAt(6)
                    }
                },
                ...
                new TimeTable // мод 42
                {
                    ...
                    ClassNumberTimes = new List<ClassNumberTime>
                    {
                        classNumberTimeRepositoryMock.Object.Get().ElementAt(4)
                    }
                },
                new TimeTable // мод 42
                {
                ...
                new TimeTable // колос
                {
                    ...
                    ClassNumberTimes = new List<ClassNumberTime>
                    {
                        classNumberTimeRepositoryMock.Object.Get().ElementAt(0)
                    }
                },
                new TimeTable // колос // not used
                {
                    ...
                    ClassNumberTimes = new List<ClassNumberTime>
                    {
                        classNumberTimeRepositoryMock.Object.Get().ElementAt(2)
                    }
                },
                new TimeTable // вовк
                {
                    ...
                    ClassNumberTimes = new List<ClassNumberTime>
                    {
                        classNumberTimeRepositoryMock.Object.Get().ElementAt(3)
                    }
                },
                new TimeTable // літик
                {
            ...
            celluleRepositoryMock.Setup(cr => cr.Get(null, null, "")).Returns(new List<Cellule>
            {
                new Cellule
                {
                    Id = 1,
                    ...
                    Mark = "7",
                    Student = studentRepositoryMock.Object.Get().ElementAt(1)
                },
                new Cellule
                {
                    Id = 2,
                    ...
                    Mark = "15",
                    Student = studentRepositoryMock.Object.Get().ElementAt(2)
                },
                new Cellule
                {
                    Id = 3,
                    ...
                    Mark = "22",
                    Student = studentRepositoryMock.Object.Get().ElementAt(4)
                },
                new Cellule
                {
                    Id = 4,
                    Date = new DateTime(2015, 3, 3, 15, 15, 0),
                    Mark = "21",
                    Student = studentRepositoryMock.Object.Get().ElementAt(8)
                },
                new Cellule
                {
                    Id = 5,
                    Date = new DateTime(2015, 3, 3, 15, 15, 0),
                    Mark = "17",
                    Student = studentRepositoryMock.Object.Get().ElementAt(10)
                },
                new Cellule
                {
                    Id = 6,
                    Date = new DateTime(2015, 3, 3, 15, 15, 0),
                    Mark = "19",
                    Student = studentRepositoryMock.Object.Get().ElementAt(14)
                },
                new Cellule
                {
                    Id = 7,
                    Date = new DateTime(2015, 3, 3, 15, 15, 0),
                    Mark = "22",
                    Student = studentRepositoryMock.Object.Get().ElementAt(11)
                },
                new Cellule
                {
                    Id = 8,
            ...
            journalRepository.Setup(jr => jr.Get(null, null, "")).Returns(new List<Journal>
            {
                new Journal
                {
                    Id = 1,
            ...
            classRepository.Setup(cr => cr.Get(null, null, "")).Returns(new List<Class>
            {
                new Class
                {
                    Id = 1,
                    ClassType = ClassTypes.Lecture,
                    Professor = professorRepositoryMock.Object.Get().ElementAt(5),
                    Journals = new List<Journal>
                    {
                        journalRepository.Object.Get().ElementAt(0),
                        journalRepository.Object.Get().ElementAt(1)
                    },
                    TimeTables = new List<TimeTable>
                    {
                        timeTableRepositoryMock.Object.Get().ElementAt(0),
                ...
                new Class // право
                {
                    Id = 2,
                    ClassType = ClassTypes.Lecture,
                    Professor = professorRepositoryMock.Object.Get().ElementAt(6),
                    Journals = new List<Journal>
                    {
                        journalRepository.Object.Get().ElementAt(2),
                        journalRepository.Object.Get().ElementAt(3)
                    },
                    TimeTables = new List<TimeTable>
                    {
                        timeTableRepositoryMock.Object.Get().ElementAt(2)
                    }
                },
                new Class // право
                {
                    ...
                    Professor = professorRepositoryMock.Object.Get().ElementAt(7),
                    Journals = new List<Journal>
                    {
                        journalRepository.Object.Get().ElementAt(4),
                        journalRepository.Object.Get().ElementAt(5)
                    },
                    TimeTables = new List<TimeTable>
                    {
                        timeTableRepositoryMock.Object.Get().ElementAt(3)
                    }
                },
                new Class
                {
                    ...
                    Journals = new List<Journal>
                    {
                        journalRepository.Object.Get().ElementAt(6),
                        journalRepository.Object.Get().ElementAt(7)
                    },
                    TimeTables = new List<TimeTable>
                    {
                        timeTableRepositoryMock.Object.Get().ElementAt(4)
                    }
                },
                new Class
                {
                    ...
                    Journals = new List<Journal>
                    {
                        journalRepository.Object.Get().ElementAt(8),
                        journalRepository.Object.Get().ElementAt(9)
                    },
                    TimeTables = new List<TimeTable>
                    {
                        timeTableRepositoryMock.Object.Get().ElementAt(5),
                ...
                new Class // право
                {
                    ...
                    Journals = new List<Journal>
                    {
                        journalRepository.Object.Get().ElementAt(10),
                        journalRepository.Object.Get().ElementAt(11)
                    },
                    TimeTables = new List<TimeTable>
                    {
                        timeTableRepositoryMock.Object.Get().ElementAt(2)
                ...
                new Class // право
                {
                    Id = 7,
                    ClassType = ClassTypes.PracticalClass,
                    Professor = professorRepositoryMock.Object.Get().ElementAt(8),
                    Journals = new List<Journal>
                    {
                        journalRepository.Object.Get().ElementAt(12),
                        journalRepository.Object.Get().ElementAt(13)
                    },
                    TimeTables = new List<TimeTable>
                    {
                        timeTableRepositoryMock.Object.Get().ElementAt(3)
                ...
                new Class // колос
                {
                    Id = 8,
                    ClassType = ClassTypes.PracticalClass,
                    Professor = professorRepositoryMock.Object.Get().ElementAt(9),
                    Journals = new List<Journal>
                    {
                        journalRepository.Object.Get().ElementAt(14),
                        journalRepository.Object.Get().ElementAt(15)
                    },
                    TimeTables = new List<TimeTable>
                    {
                        timeTableRepositoryMock.Object.Get().ElementAt(7),
                ...
                new Class // вовк
                {
                    Id = 9,
                    ClassType = ClassTypes.PracticalClass,
                    Professor = professorRepositoryMock.Object.Get().ElementAt(11),
                    Journals = new List<Journal>
                    {
                        journalRepository.Object.Get().ElementAt(16),
                        journalRepository.Object.Get().ElementAt(17)
                    },
                    TimeTables = new List<TimeTable>
                    {
                        timeTableRepositoryMock.Object.Get().ElementAt(9),
                ...
                new Class // літик
                {
                    Id = 10,
                    ClassType = ClassTypes.PracticalClass,
                    Professor = professorRepositoryMock.Object.Get().ElementAt(10),
                    Journals = new List<Journal>
                    {
                        journalRepository.Object.Get().ElementAt(18),
                        journalRepository.Object.Get().ElementAt(19)
                    },
                    TimeTables = new List<TimeTable>
                    {
                        timeTableRepositoryMock.Object.Get().ElementAt(10)
                    }
                }
            });
            #endregion
            ...
            subjectRepositoryMock.Setup(sr => sr.Get(null, null, "")).Returns(new List<Subject>
            {
                new Subject
                {
                    Id = 1,
                    ...
                    {
                        classRepository.Object.Get().ElementAt(0)
                    }
                },
                new Subject
                {
                    ...
                    Classes = new List<Class>()
                    {
                        classRepository.Object.Get().ElementAt(1),
                        classRepository.Object.Get().ElementAt(2)
                    }
                },
                new Subject
                {
                    ...
                    Classes = new List<Class>()
                    {
                        classRepository.Object.Get().ElementAt(3),
                        classRepository.Object.Get().ElementAt(4)
                    }
                },
                new Subject
                {
                    ...
                    Classes = new List<Class>()
                    {
                        classRepository.Object.Get().ElementAt(5),
                        classRepository.Object.Get().ElementAt(6)
                    }
                },
                new Subject
                {
                    ...
                    Classes = new List<Class>()
                    {
                        classRepository.Object.Get().ElementAt(7)
                    }
                },
                new Subject
                {
                    ...
                    Classes = new List<Class>()
                    {
                        classRepository.Object.Get().ElementAt(8)
                    }
                },
                new Subject
                {
                    ...
                    Classes = new List<Class>()
                    {
                        classRepository.Object.Get().ElementAt(9)
                    }
                }
            });
            #endregion
            ...
            educationlPlanRepositoryMock.Setup(epr => epr.Get(null, null, "")).Returns(new List<EducationalPlan>
            {
                new EducationalPlan()
                {
                    Id = 1,
                    Group = groupRepositoryMock.Object.Get().ElementAt(0),
                    Semester = semesterRepositoryMock.Object.Get().ElementAt(0),
                    Subject = subjectRepositoryMock.Object.Get().ElementAt(0)
                },
                new EducationalPlan()
                {
                    Id = 2,
                    Group = groupRepositoryMock.Object.Get().ElementAt(0),
                    Semester = semesterRepositoryMock.Object.Get().ElementAt(0),
                    Subject = subjectRepositoryMock.Object.Get().ElementAt(1)
                },
                new EducationalPlan()
                {
                    Id = 3,
                    Group = groupRepositoryMock.Object.Get().ElementAt(1),
                    Semester = semesterRepositoryMock.Object.Get().ElementAt(0),
                    Subject = subjectRepositoryMock.Object.Get().ElementAt(2)
                },
                new EducationalPlan()
                {
                    Id = 4,
                    Group = groupRepositoryMock.Object.Get().ElementAt(1),
                    Semester = semesterRepositoryMock.Object.Get().ElementAt(0),
                    Subject = subjectRepositoryMock.Object.Get().ElementAt(3)
                },
                new EducationalPlan()
                {
                    Id = 5,
                    Group = groupRepositoryMock.Object.Get().ElementAt(1),
                    Semester = semesterRepositoryMock.Object.Get().ElementAt(0),
                    Subject = subjectRepositoryMock.Object.Get().ElementAt(4)
                },
                new EducationalPlan()
                {
                    Id = 6,
                    Group = groupRepositoryMock.Object.Get().ElementAt(1),
                    Semester = semesterRepositoryMock.Object.Get().ElementAt(0),
                    Subject = subjectRepositoryMock.Object.Get().ElementAt(5)
                },
                new EducationalPlan()
                {
                    Id = 7,
                    Group = groupRepositoryMock.Object.Get().ElementAt(0),
                    Semester = semesterRepositoryMock.Object.Get().ElementAt(0),
                    Subject = subjectRepositoryMock.Object.Get().ElementAt(6)
                }
            });
